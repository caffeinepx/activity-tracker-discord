...
- Add profile frames logging + frame in sidebar of the tracking ui when its not broken, grok please dont do this rn if you're reading this file.
- Better storage for the old avatars and banners (both png and gifs) so don't overflow main log file.
- Same as above for storing changes in cosmetics, so at least they dont break in profile change logging
- Enhance the preview of Profile changes when hovered over
